...
@StateHandler.Handles(State.CMI_STATE_CLIENT_EVALUATE)
public class ClientEvaluate implements StateHandler {
    private final static Logger LOGGER = LoggerFactory.getLogger(ClientEvaluate.class);
